          ...
          >
            ...
            <thead>
              <tr className="bg-gray-50">
                <th className="text-left px-3 py-2.5 text-gray-500 font-medium bg-gray-50">
                  Part No
                </th>
                <th className="text-right px-3 py-2.5 text-gray-500 font-medium bg-gray-50">
                  Stock
                </th>
                {weeks.map((wk) => (
                  <th
                    key={wk}
                    className="text-right px-2 py-2.5 text-gray-400 font-normal border-l border-gray-100 bg-gray-50"
                  >
                    {weekLabel(wk)}
                  </th>
                ))}
...
function SummaryRow({ part, weeks }) {
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="px-3 py-2 bg-gray-50">
                      <div className="space-y-0.5">
                        {[
                          ...
                          <div
                            key={i}
                            className="text-xs text-right text-orange-600 font-medium truncate"
                          >
                            {c}
                          </div>
                        ))}
                    ...
                    {part.weeks.map((_, i) => (
                      <td
                        key={i}
                        className="px-2 py-2 border-l border-gray-100 bg-white"
                      ></td>
                    ))}
                  </tr>
